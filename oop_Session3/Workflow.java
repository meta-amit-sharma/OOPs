...
public class Workflow {
	...
	String workflow_name;										//variable to store workflow name
	List<Event> event_list = new ArrayList<>();					//list of event type objects
	List<Transition> transition_list = new ArrayList<>();		//list of transition type objects
	LinkedList<State> state_list = new LinkedList<>();			//linked list of state objects
	/**
